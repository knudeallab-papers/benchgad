...
entire <- df
entire$Evolution <- sapply(entire$Evolution, function(x){ifelse(x=='3090', 3, ifelse(x=='2080ti', 2, 1))})
...
dbms <- df
dbms$Evolution <- sapply(dbms$Evolution, function(x){ifelse(x=='3090', 3, ifelse(x=='2080ti', 2, 1))})
