...
# PG-Strom without DB > 8
pgstrom_withoutDB8 <- preprocessed_dataset[!((preprocessed_dataset$DBMS=='PG-Strom') & (preprocessed_dataset$`Size. of DB`>8)),] %>% Normalize_GroupbyDBMS('PG-Strom')

# OmniSci
omnisci <- Normalize_GroupbyDBMS(preprocessed_dataset,"OmniSci",nontime_feature,time_feature)

# PG-Strom DB > 8 contained Entire Dataframe
