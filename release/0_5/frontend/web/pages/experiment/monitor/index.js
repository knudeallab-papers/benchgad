  ...
  return (
    <Layout>
      <div className={styles['monitor-wrapper']}>
        <div className={styles['monitor-nav-label']}>Experiment -> Monitor Experiments</div>
        <div className={styles['monitor-title-wrapper']}>
          <div className={styles['title']}>Monitor Experiments</div>
...
export default MonitorExperiment;
